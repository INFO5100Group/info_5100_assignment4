...
DefaultTreeModel model=(DefaultTreeModel)jTree.getModel();
       // Add the code for draw your system structure shown by JTree
        ...
        DefaultMutableTreeNode organizations=new DefaultMutableTreeNode("Organization");
        DefaultMutableTreeNode root=(DefaultMutableTreeNode)model.getRoot();
        root.removeAllChildren();
        root.insert(organizations, 0);
        
        DefaultMutableTreeNode deliveryManNode;
        DefaultMutableTreeNode customerNode;
        DefaultMutableTreeNode organizationNode;
        DefaultMutableTreeNode restraurantNode;
        
     
       /*     Restaurantlist=network.getEnterpriseDirectory().getEnterpriseList();
            for(int j=0; j<Restaurantlist.size();j++){
                restraurant=Restaurantlist.get(j);
                restraurantNode=new DefaultMutableTreeNode(restraurant.getName());
                organizations.insert(restraurantNode, j);                
            }
            DeliveryManlist=network.getEnterpriseDirectory().getEnterpriseList();
            for(int j=0; j<DeliveryManlist.size();j++){
                ...
                organizations.insert(deliveryManNode, j);                
            }   */        
            Customerlist= customerDir.getCustomerList();
            for(int j=0; j<Customerlist.size();j++){
                customer=Customerlist.get(j);
                customerNode=new DefaultMutableTreeNode(customer.getName());
                organizations.insert(customerNode, j);                
            }           
